  ...
  return (
    <div className="flex flex-col gap-6 p-4">
      <div className="flex justify-between items-center border-b pb-4">
        <h2 className="text-xl font-bold uppercase">My Courses</h2>
        <span className="text-sm text-gray-500">
          {user?.username ? (
            <>
              Showing your enrolledd{" "}
      ...
      {loading ? (
        <div className="bg-white rounded-md shadow-sm border border-gray-100 p-6 text-center text-gray-500">
          Loading courses...
        </div>
        ...
        <div className="bg-white rounded-md shadow-sm border border-gray-100 p-4">
          <div className="flex justify-between items-center mb-4 border-b pb-2">
            <h3 className="font-semibold text-gray-700">Courses Allotted</h3>
